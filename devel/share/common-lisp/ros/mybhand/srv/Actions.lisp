...
(cl:defmethod cl:initialize-instance :after ((m <Actions-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Actions-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mybhand-srv:<Actions-request> is deprecated: use mybhand-srv:Actions-request instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <Actions-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mybhand-srv:action-val is deprecated.  Use mybhand-srv:action instead.")
  (action m))
...
(cl:defmethod cl:initialize-instance :after ((m <Actions-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Actions-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mybhand-srv:<Actions-response> is deprecated: use mybhand-srv:Actions-response instead.")))

(cl:ensure-generic-function 'ret-val :lambda-list '(m))
(cl:defmethod ret-val ((m <Actions-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mybhand-srv:ret-val is deprecated.  Use mybhand-srv:ret instead.")
  (ret m))
